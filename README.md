...
Tratamento de dados, análise exploratória, seleção e construção de um modelo de preços de imóveis em Belo Horizonte utilizando uma base de dados disponibilizada no Kaggle.
